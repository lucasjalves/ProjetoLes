	...
	<form id="form">
		...
		<div class="form-group">
			<label>Nome Completo</label> <input type="text" class="form-control"
				name="nome" placeholder="Nome" value="Nome teste" required disabled>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label>Data nascimento</label> <input type="text"
				...
				value="23/07/1997"  required disabled>
		</div>
		<div class="form-group">
			<label>E-mail</label> <input type="text" class="form-control"
				placeholder="E-mail" value="teste@teste.com.br" required disabled>
		</div>
		<div class="form-group">
			<label>Gênero</label> <select class="form-control" disabled>
		...
		<div class="form-group">
			<label>Username</label> <input type="text" class="form-control"
				name="username" placeholder="Username" value="usertest" required disabled>
		</div>
		<div class="form-group">
			<label>Senha</label> <input type="password" class="form-control"
				name="senha" placeholder="Senha" value="senhatest" required disabled>
		</div>
	</form>
	<a href="http://localhost:8888/ticket/consultaAdmin" class="btn btn-info" id="btnCadastrar">Voltar</a>
